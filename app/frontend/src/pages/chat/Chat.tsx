                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Welcome to Andrew's IS Pirate Help Desk</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Chat with your data. Ask anything or try an example</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. how to find treasure?)"
                            disabled={isLoading}
